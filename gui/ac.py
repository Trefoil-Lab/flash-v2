...
from .ui.ACMainWindow import Ui_MainWindow
    ...
    def __init__(self, *args, obj=None, **kwargs):
        ...
        self.control_thread = ControlRunner(self.signals, 
                                            Params(
                                                ...
                                                freq=self.frequencyHzDoubleSpinBox.value(),
        ...
        self.statusbar.addPermanentWidget(self.readoutS)
        self.readoutS.hide()
...
class FlashConnectDialog(Ui_Dialog, QDialog):
    """
    Dialog that is shown when the connect button is pressed in the AC
